TRUNCATE TABLE board, list, card RESTART IDENTITY CASCADE;

INSERT INTO board (name) VALUES
    ('サンプルボード');

INSERT INTO list (name, board_id, display_order) VALUES
    ('未着手', 1, 0),
    ('作業中', 1, 1),
    ('完了',   1, 2);

INSERT INTO card (title, description, due_date, list_id, display_order) VALUES
